...
namespace UnityUserInput {
    [CreateAssetMenu(menuName="Input/Actions/Set Marching Value")]
    public class SetMarchingValueAct : Action {
                ...
                for (int z = -radius; z < radius; z++) {
                    for (int x = -radius; x < radius; x++) {
                        if (x * x + z * z <  threshold) {
                            ...
                            //gridData.additionalValueHeightMap[x,z] = gridData.GetMarchingValue(x, y, z) - gridData.terrainMarchingSurface;
                        }
                    }
                } 
